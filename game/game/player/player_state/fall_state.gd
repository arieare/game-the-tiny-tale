...
func process_physics(delta: float) -> State:
	...
	tween_arm_right.tween_property(arm_right,"position",arm_target_fall_right.position,0.05)
	tween_arm_left.tween_property(arm_left,"position",arm_target_fall_left.position,0.05)
